...
Dzen Unified RSS — независимая замена, не зависит от сторонних RSS-плагинов.
...
Варианты 1 и 2 включает отдельное платное дополнение **Dzen Unified RSS Pro** — устанавливается
...
3. Настройки → Dzen Unified RSS, вкладка «Основное» — укажите лимит возраста, логотипы, исключения.
...
Нет. Dzen Unified RSS полностью самостоятелен, сам генерирует XML и обрабатывает контент, не зависит от других плагинов.
...
Кнопка «Купить лицензию» на вкладке «Pro» ведёт на страницу оплаты. После оплаты на почту приходит ссылка на скачивание дополнения Dzen Unified RSS Pro и ключ активации — устанавливаете дополнение поверх этого плагина и вставляете ключ на той же вкладке.
...
* Pro-функциональность (варианты 1 и 2) и лицензирование вынесены в отдельное дополнение
  Dzen Unified RSS Pro — этот плагин теперь на 100% бесплатный и полностью рабочий сам по себе,
...
= 1.2.0 =
Если у вас была включена Pro-функциональность — установите отдельное дополнение Dzen Unified RSS Pro и активируйте лицензию заново на вкладке «Pro» после обновления этого плагина.
